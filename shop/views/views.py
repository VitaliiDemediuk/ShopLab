...
def brands(request):
    sections = section_brand_services.get_sections_with_categories()
    all_brands = section_brand_services.get_brands()
...
def product(request, product_id):
    sections = section_brand_services.get_sections_with_categories()
    goods = goods_services.get_goods_by_id(product_id)
...
def section(request, section_link_name):
    sections = section_brand_services.get_sections_with_categories()
    goods_list = goods_services.get_goods_list(section_link_name=section_link_name)
...
def category(request, section_link_name, category_link_name):
    sections = section_brand_services.get_sections_with_categories()
    goods_list = goods_services.get_goods_list(section_link_name=section_link_name, category_link_name=category_link_name)
    if goods_list is None:
...
def brand(request, brand_link_name):
    sections = section_brand_services.get_sections_with_categories()
    goods_list = goods_services.get_goods_list(brand_link_name=brand_link_name)
    if goods_list is None:
