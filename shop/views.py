...
def brands(request):
    ...
    return render(request, 'shop/brands.html', {'brands': all_brands, 'img_link_prefix': DOMAIN+MEDIA_URL})
...
def product(request, product_id):
    ...
    if goods is None or not goods['is_enable']:
        ...
        return render(request, 'shop/product.html', {'goods': goods, 'img_link_prefix': DOMAIN + MEDIA_URL})
...
def section(request, section_link_name):
    ...
    if goods_list is None:
        ...
        return render(request, 'shop/product_list.html', {'goods_list': goods_list,
